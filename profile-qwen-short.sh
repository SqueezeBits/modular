...
T2I_OUTPUT="${T2I_OUTPUT:-${PROFILE_DIR}/qwen_t2i_short.png}"
EDIT_OUTPUT="${EDIT_OUTPUT:-${PROFILE_DIR}/qwen_edit_short.png}"

EDIT_INPUT_WOMAN="${EDIT_INPUT_WOMAN:-woman_e2e.png}"
EDIT_INPUT_MAN="${EDIT_INPUT_MAN:-man_e2e.png}"

T2I_BASE="${PROFILE_DIR}/qwen_t2i_short"
EDIT_BASE="${PROFILE_DIR}/qwen_edit_short"
