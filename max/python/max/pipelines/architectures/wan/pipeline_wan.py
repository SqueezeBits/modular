...
class WanPipeline(DiffusionPipeline):
    ...
    def _prepare_prompt_state(
        ...
        # Always use 2-pass CFG (positive and negative run separately)
        # to halve peak activation memory vs batched (batch=2) approach.
        return (
            prompt_embeds,
            negative_prompt_embeds_buf,
            None,  # batched_prompt_embeds — None forces 2-pass path
            do_cfg,
        )
