...
"""Flux2 attention and feedforward layers using module_v3."""
...
from max.nn.module_v3 import module_dataclass
...
class Flux2Attention(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            dropout: Dropout rate (not used in module_v3).
        ...
        self.to_out.append(nn.Linear(self.inner_dim, out_dim, bias=out_bias))
...
class Flux2ParallelSelfAttention(nn.Module):
    ...
    def __init__(
        ...
        self.to_qkv_mlp_proj = nn.Linear(query_dim, fused_dim, bias=bias)
