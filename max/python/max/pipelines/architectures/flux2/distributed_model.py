...
"""Distributed Flux2 Transformer model loader."""
...
from .distributed_flux2 import DistributedFlux2Transformer2DModel
from .model_config import Flux2Config


class DistributedFlux2TransformerModel(ComponentModel):
    """Multi-GPU tensor-parallel Flux2 transformer model."""
    ...
    def load_model(self) -> Callable[..., Any]:
        ...
        nn_model = DistributedFlux2Transformer2DModel(
            self.config, self.device_refs
        )
        # load_state_dict with strict=False: sharded layers have different
