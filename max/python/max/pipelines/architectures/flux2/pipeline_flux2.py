        ...
        **kwargs: Any,
        ...
        if condition_images is not None:
            ...
            for img in condition_images:
                ...
                img_tensor = Tensor.from_dlpack(img_array).to(device)
        ...
        for i in tqdm(range(self._num_timesteps), desc="Denoising"):
            ...
            # Convert driver.Tensor back to Tensor if needed (before concat)
            if not isinstance(random_latents, Tensor):
                random_latents = Tensor.from_dlpack(random_latents)
        ...
        if output_type == "latent":
            ...
            # Convert to Tensor if needed (latents may be driver.Tensor after scheduler.step)
