...
"""Attention module for VAE models.

This module provides spatial attention for 2D image tensors in VAE decoders.
"""
...
from .normalizations import WeightedGroupNorm
...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        self.group_norm = WeightedGroupNorm(
