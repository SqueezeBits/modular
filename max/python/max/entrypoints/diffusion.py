...
class _Request:
    ...
    def __post_init__(self) -> None:
        ...
        self.num_inference_steps = normalize_sequence(self.num_inference_steps, length)
        self.guidance_scale = normalize_sequence(self.guidance_scale, length)
        self.num_images_per_prompt = normalize_sequence(self.num_images_per_prompt, length)
        self.negative_prompts = normalize_sequence(self.negative_prompts, length)
