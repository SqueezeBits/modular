    ...
    comptime if input.rank == 4:
        ...
        if filter_is_fcrs:
            conv3d_cudnn[input_type, filter_type, output_type](
                LayoutTensor[input_type, Layout.row_major[5](), MutAnyOrigin](
                    input.ptr,
                    RuntimeLayout[Layout.row_major[5]()].row_major(
                        input.runtime_layout.shape.value.canonicalize(),
                    ),
                ),
                LayoutTensor[filter_type, Layout.row_major[5](), MutAnyOrigin](
                    filter.ptr,
                    RuntimeLayout[Layout.row_major[5]()].row_major(
                        filter.runtime_layout.shape.value.canonicalize(),
                    ),
                ),
                LayoutTensor[output_type, Layout.row_major[5](), MutAnyOrigin](
                    output.ptr,
                    RuntimeLayout[Layout.row_major[5]()].row_major(
                        output.runtime_layout.shape.value.canonicalize(),
                    ),
