...
Groups
------
attention    : flash attention / MAX SM100 MHA kernels
matmul       : cuBLAS / cutlass / nvjet GEMM kernels
...
def classify_kernel(name: str) -> str:
    ...
    # --- Attention ---
    # MAX: nn_mha_sm100_2q_SM100MHA2Q_ke*
    ...
    # --- Matmul / linear ---
    # MAX and diffusers both use cuBLAS (nvjet) or cutlass
